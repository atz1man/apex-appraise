  ...
  theme: {
    extend: {
      colors: {
        ...
        'ink-2': 'rgb(var(--ink-2, 75 81 75) / <alpha-value>)',
        'ink-2b': 'rgb(var(--ink-2b, 87 90 83) / <alpha-value>)',
        'ink-3': 'rgb(var(--ink-3, 95 98 95) / <alpha-value>)',
        'ink-3b': 'rgb(var(--ink-3b, 107 107 102) / <alpha-value>)',
        inactive: 'rgb(var(--inactive, 99 103 99) / <alpha-value>)',
        'status-amber': 'rgb(var(--status-amber, 149 95 17) / <alpha-value>)',
