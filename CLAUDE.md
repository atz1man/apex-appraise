...
- `pnpm --filter @apex/appraisal-engine test` — engine tests (79; golden Bournemouth fixture
  locked to the penny — GDV £4,278,000, residual £406,711.36, PoC 25%).
- `cd apps/web && npx playwright test` — e2e (45; needs web 5273 + api 4100 running).
